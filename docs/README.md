...
3. [EventBus](./EventBus.md): 事件总线机制，15 种事件类型和完整事件流
...
7. [ContextManagementDevelopmentPlan](./ContextManagementDevelopmentPlan.md): 基于 Claude Code 上下文管理分析制定的 feature/context 开发计划
